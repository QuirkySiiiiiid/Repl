...
# Define the download directory in the current workspace
DOWNLOAD_DIR = "./down6"  # A writable folder within the workspace
...
if __name__ == "__main__":
    playlist_url = "https://youtube.com/playlist?list=PL9Zg64loGCGBN9D-dev7aJIwmO19xgFpa&si=MOW8LgCOH2zo7lj9"  # Replace with the actual playlist URL
